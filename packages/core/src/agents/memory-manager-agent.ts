...
- Subdirectory GEMINI.md files (e.g. \`src/GEMINI.md\`, \`docs/GEMINI.md\`) —
  detailed, domain-specific context for that part of the project. Add a
  markdown link in the root table of contents pointing to each subdirectory
  file (e.g. \`- [Frontend conventions](../src/GEMINI.md)\`).
...
- Detailed context about a specific module or directory → **subdirectory
  GEMINI.md**, with a markdown link added to the project root table of contents
